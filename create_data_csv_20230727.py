...
if __name__ == '__main__':
    ...
    all_df.to_csv('output/update_allcruises_df_5with_zoomie_20230727.csv', sep=";")
    validated_df = create_validate_df(all_df)
    overview_labels, overview_labels_100 = create_label_overview(validated_df)
    dict_babsi = create_agg_labels(path ="data/combine_classes_for_training_20230727.csv")
    ...
    df_phase.to_csv('output/update_allcruises_df_validated_5with_zoomie_20230727.csv',sep=";")
