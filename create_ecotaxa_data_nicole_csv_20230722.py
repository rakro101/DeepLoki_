...
def create_validated_sub_data_set(validated_df,excluded):
    ...
    print(validated_df_zero.shape)
    validated_df_zero.to_csv('data_csv/data_run_nicole.csv',sep =";")
...
if __name__ == '__main__':
    ...
    all_df.to_csv('output/df_ecoTaxa_nicole_dataPS99_20230722.csv')
    ...
    df_phase.to_csv('output/ecoTaxa_nicole_dataPS992_20230722.csv')
