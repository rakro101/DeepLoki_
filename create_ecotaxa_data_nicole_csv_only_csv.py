...
def create_label_overview(validated_df):
    ...
    overview_labels.to_csv('output/annotation_overview_nicole.csv',";")
    overview_labels_100 =overview_labels.iloc[:100]
    overview_labels_100.to_csv('output/combine_classes_for_training_nicole.csv', sep=";")
...
def create_validated_sub_data_set(validated_df,excluded):
    ...
    print(validated_df_zero.shape)
    validated_df_zero.to_csv('data_csv/only_calanus_data_run_nicole.csv',sep =";")
...
if __name__ == '__main__':
    data_root_path = "data/ecoTaxa_nicole"
    all_df = create_all_data_df(data_root_path)
    all_df.to_csv('output/df_ecoTaxa_nicole_dataPS99_0230303.csv')
    validated_df = create_validate_df(all_df)
    overview_labels, overview_labels_100 = create_label_overview(validated_df)
    # diff for only calanus
    dict_babsi = create_agg_labels(path ="data/data/combine_classes_for_training 3.csv")
    ...
    df_phase.to_csv('output/only_calanus_ecoTaxa_nicole_dataPS992_0230303.csv')
