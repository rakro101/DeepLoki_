...
class LokiDataset(Dataset):
    def __init__(self, img_transform=None, feat_transform=None, target_transform=None):
        ...
        self.scaler.fit(self.imputer_num.fit_transform(self.df_abt[numeric_columns]))
        self.features = torch.Tensor(self.scaler.transform(self.imputer_num.fit_transform(self.df_abt[numeric_columns])))
...
class LitModel(pl.LightningModule):
    def __init__(self, input_shape, num_classes, learning_rate=2e-4, transfer=False, num_train_layers=3):
        super().__init__()
        ...
        # print cuda
        self.print_cuda()
        self.feature_extractor = models.resnet101(pretrained=transfer)
...
if __name__ == '__main__':
    ...
    model = LitModel((3, 300, 300), 43, transfer=True, num_train_layers=3)
    trainer = pl.Trainer(max_epochs=25, accelerator="auto", devices="auto")
